...
def like():
    ...
    and programming interfaces, for project distributions the current
...
def codename():
    ...
    project, openSUSE returns "x86_64". This function does not handle such
...
def info(pretty=False, best=False):
    ...
    distribution in a dictionary, as shown in the following project:
