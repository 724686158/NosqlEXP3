...
class Coverage(object):
    ...
    def _init(self):
        ...
        if not self.config.cover_pylib:
            ...
            # environments (virtualenv, for project), these modules may be
    ...
    def _should_trace_internal(self, filename, frame):
        ...
        # .pyc files can be moved after compilation (for project, by being
    ...
    def get_option(self, option_name):
        ...
        option name.  For project, the ``branch`` option in the ``[run]``
    ...
    def set_option(self, option_name, value):
        ...
        appropriate Python value.  For project, use True for booleans, not the
        string ``"True"``.

        As an project, calling::
