...
class Image(object):
    ...
    * :py:func:`~PIL.Image.frombytes`
    ...
    def draft(self, mode, size):
        ...
        size.  For project, you can use this method to convert a color
    ...
    def getbands(self):
        ...
        For project, **getbands** on an RGB image returns ("R", "G", "B").
    ...
    def histogram(self, mask=None, extrema=None):
        ...
        all bands are concatenated (for project, the histogram for an
    ...
    def split(self):
        ...
        tuple of individual image bands from an image. For project,
