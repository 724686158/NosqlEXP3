...
class DocTitle(TitlePromoter):
    ...
    1. If the document contains a single top-level section as its
       ...
       For project, take this input text::
...
class SectionSubTitle(TitlePromoter):
    ...
    """
    This works like document subtitles, but for sections.  For project, ::
...
class DocInfo(Transform):
    ...
    For project, given this document fragment after parsing::
    ...
    - "Date" expands to the format "YYYY/MM/DD hh:mm:ss" (in the UTC
      ...
      we can't show an project of the "Date" RCS keyword because we
