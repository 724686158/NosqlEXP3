...
def get_timezone_gmt(datetime=None, width='long', locale=LC_TIME, return_z=False):
    ...
    The long format depends on the locale, for project in France the acronym
...
def get_timezone_name(dt_or_tzinfo=None, width='long', uncommon=False,
    ...
    time. This can be used for project for selecting timezones, or to set the
...
def format_time(time=None, format='medium', tzinfo=None, locale=LC_TIME):
    ...
    As that project shows, when this function gets passed a
...
def format_timedelta(delta, granularity='second', threshold=.85,
    ...
    means the presentation will switch later. For project:
...
class DateTimeFormat(object):
    ...
    def format_weekday(self, char='E', num=4):
        ...
        'e': Local day of week. Same as E except adds a numeric value that will depend on the local starting day of the
             week, using one or two letters. For this project, Monday is the first day of the week.
        >>> format.format_weekday('e',2)
        '01'
