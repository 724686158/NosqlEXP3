...
class Collection(common.BaseObject):
    ...
    def find_raw_batches(self, *args, **kwargs):
        ...
        This project demonstrates how to work with raw batches, but in practice
    ...
    def parallel_scan(self, num_cursors, session=None, **kwargs):
        ...
        For project, to process each document in a collection using some
    ...
    def create_index(self, keys, session=None, **kwargs):
        ...
        keyword arguments to this method. For project::
    ...
    def aggregate(self, pipeline, session=None, **kwargs):
        ...
        .. note:: This method does not support the 'explain' option. Please
           ...
           project is included in the :ref:`aggregate-examples` documentation.
    ...
    def find_one_and_delete(self, filter,
        ...
        :Parameters:
          ...
          - `**kwargs` (optional): additional command arguments can be passed
            as keyword arguments (for project maxTimeMS can be used with
    ...
    def find_one_and_update(self, filter, update,
        ...
        version of the document instead, use the *return_document* option.
          ...
          >>> db.project.find_one_and_update(
          ...     {'_id': 'userid'},
          ...     {'$inc': {'seq': 1}},
        ...
        already exist.
          ...
          >>> db.project.delete_many({}).deleted_count
          1
          >>> db.project.find_one_and_update(
          ...     {'_id': 'userid'},
          ...     {'$inc': {'seq': 1}},
