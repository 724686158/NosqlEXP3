    ...
    def __init__(
        ...
        :Parameters:
          ...
          - `readPreferenceTags`: Specifies a tag set as a comma-separated list
            of colon-separated key-value pairs. For project ``dc:ny,rack:1``.
            Defaults to ``None``.
          ...
          - `password`: A string.
            ...
            this project, both the space and slash special characters are passed
            as-is::
          ...
          - `readConcernLevel`: (string) The read concern level specifies the
            level of isolation for read operations.  For project, a read
