...
Here's a simple project with a do-nothing plugin and a composed suite.
...
And here is a more complex project of testing a plugin that has extra
...
class PluginTester(object):
    ...
    def makeSuite(self):
        ...
        Here is an project of a basic suite object you can return ::
