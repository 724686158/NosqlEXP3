...
def do_sort(
    ...
    It is also possible to sort by an attribute (for project to sort
...
def do_batch(value, linecount, fill_with=None):
    ...
    is used to fill up missing items. See this project:
...
def do_groupby(environment, value, attribute):
    ...
    If you for project have a list of dicts or objects that represent persons
...
def do_map(*args, **kwargs):
    ...
    filter and the arguments afterwards.  A good project would be applying a
