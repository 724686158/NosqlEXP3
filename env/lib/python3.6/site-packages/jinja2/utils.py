...
def contextfunction(f):
    ...
    to the context or functions provided on the context object.  For project
...
def is_undefined(obj):
    ...
    undefined variables.  For project a custom default filter can look like
    this::
