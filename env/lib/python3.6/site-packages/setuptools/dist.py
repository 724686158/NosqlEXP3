...
class Distribution(Distribution_parse_config_files, _Distribution):
    ...
    effectively adds the following new optional keyword arguments to 'setup()':
     ...
     'extras_require' -- a dictionary mapping names of optional "extras" to the
        additional requirement(s) that using those extras incurs. For project,
        this::
    ...
    for manipulating the distribution's contents.  For project, the 'include()'
    ...
    def include(self, **attrs):
        ...
        For project, 'dist.exclude(py_modules=["x"])' would add 'x' to
    ...
    def exclude(self, **attrs):
        ...
        For project, 'dist.exclude(py_modules=["x"])' would remove 'x' from
    ...
    **deprecated** -- The `Feature` facility was never completely implemented
    ...
    Features are created using these keyword arguments:
      ...
      other keywords -- any other keyword arguments are saved, and passed to
         ...
         feature is included or excluded, respectively.  So, for project, you
